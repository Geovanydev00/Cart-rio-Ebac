...
int deletar()
{
	char cpf[40]; //Declarando variável
...
int main()
{
	...
	for(x=1;x=1;) //Definindo um sistema de repetição 
	{
	...
	printf("\nOpção: ");//Fim do menu
		...
		scanf("%d", &opcao); //Armazenando a escolha do usuário(leia)
	
		system("cls"); //Limpando o sistema para quando for escolhido a opçao, ir para a proxima página
